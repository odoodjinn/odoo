...
class ResConfigSettings(models.TransientModel):
   ...
   primary_user = fields.Many2one(comodel_name='res.users', string='Primary Approval User',
         config_parameter='spotter_sale_order_approval.primary_user',
         help='Primary approval person for the SO above 25K ')
   secondary_user = fields.Many2one(comodel_name='res.users', string='Secondary Approval User',
